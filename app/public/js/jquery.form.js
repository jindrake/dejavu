 ...
 */
  $.fn.ajaxSubmit = function (options) {
    ...
    var method; var action; var url; var $form = this
    ...
    var elements = []
    var qx; var a = this.formToArray(options.semantic, elements)
    if (options.data) {
    ...
    function fileUploadIframe (a) {
      var form = $form[0]; var el; var i; var s; var g; var id; var $io; var io; var xhr; var sub; var n; var timedOut; var timeoutHandle
      ...
      function doSubmit () {
        ...
        var t = $form.attr2('target'); var a = $form.attr2('action')
      ...
      var data; var doc; var domCheckCount = 50; var callbackProcessed
 ...
 */
  $.fn.formToArray = function (semantic, elements) {
    ...
    if (!semantic && form.clk) {
      ...
      var $input = $(form.clk); var input = $input[0]
      n = input.name
 ...
 */
  $.fieldValue = function (el, successful) {
    var n = el.name; var t = el.type; var tag = el.tagName.toLowerCase()
 ...
 */
  $.fn.clearFields = $.fn.clearInputs = function (includeHidden) {
    ...
    return this.each(function () {
      var t = this.type; var tag = this.tagName.toLowerCase()
